...
| `triggers.include.branch` :fontawesome-brands-github: | [String or regex] | Branches whose names exactly match should trigger the automation.     |
| `triggers.exclude.branch` :fontawesome-brands-github: | [String or regex] | Branches whose names exactly match should not trigger the automation. |
| `triggers.include.repository`                         | [String or regex] | Repositories that should trigger the automation.           |
| `triggers.exclude.repository`                         | [String or regex] | Repositories that should not trigger the automation.       |
